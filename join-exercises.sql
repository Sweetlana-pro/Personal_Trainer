...
SELECT
    ...
    l.EmailAddress
FROM login l
RIGHT OUTER JOIN Client c ON c.ClientId = l.ClientId
...
INNER JOIN ExerciseCategory child ON parent.ExerciseCategoryId = child.ParentCatergoryId;
